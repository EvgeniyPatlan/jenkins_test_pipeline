    ...
    stage('Build percona-server source') {
      steps {
        sh '''
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                cd ${build_dir}
apt-get -y update;
apt-get -y install wget  ;                                                                                                                                                                                                                                                                              mkdir source_tarball;
cd source_tarball;
wget https://www.percona.com/downloads/Percona-Server-LATEST/Percona-Server-8.0.20-11/source/tarball/percona-server-8.0.20-11.tar.gz;
cd -;"
                                                                                                                                                                                                                                                            '''
    ...
    stage('Build PS generic source rpm') {
      steps {
        dir(path: 'source_tarball') {
          unstash 'source_tarball'
        }

        unstash 'percona-server*.tar.gz'
        sh """
                                                                                                                                                                                                                                                                                                                                                                                                        set -o xtrace
                                                                                                                                                                                                                                                                                                                                                                                                        rm -rf test
                                                                                                                                                                                                                                                                                                                                                                                                        mkdir test
